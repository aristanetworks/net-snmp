...
typedef struct netsnmp_ipstats_s {
   ...
   NSU64             HCOutRequests;
   NSU64             HCOutNoRoutes;
   NSU64             HCOutForwDatagrams;
   NSU64             HCOutDiscards;
   
   /* optional, can be computed from HCOutFragOKs + HCOutFragFails*/
   NSU64             HCOutFragReqds;
   NSU64             HCOutFragOKs;
   NSU64             HCOutFragFails;
   NSU64             HCOutFragCreates;
   
   /* optional, can be computed from 
    * HCOutRequests +HCOutForwDatagrams + HCOutFragCreates
    * - HCOutFragReqds - HCOutNoRoutes  - HCOutDiscards */
   NSU64             HCOutTransmits;
   
   NSU64             HCOutOctets;
   NSU64             HCInMcastPkts;
   NSU64             HCInMcastOctets;
   NSU64             HCOutMcastPkts;
   NSU64             HCOutMcastOctets;
   NSU64             HCInBcastPkts;
   NSU64             HCOutBcastPkts;
